        ...
        <main className="min-h-screen bg-black">
            ...
            <section className="pt-40 pb-24 px-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="relative mb-24 mt-32 text-center">
                        <div className="inline-block relative">
                            <span className="text-[10px] font-black text-pop-primary uppercase tracking-[0.4em] block mb-2">Important Notes</span>
                            <h2 className="text-3xl md:text-4xl font-bold text-white tracking-tight px-8 relative z-10">
                                注意事項
                            </h2>
                        </div>
                    </div>
