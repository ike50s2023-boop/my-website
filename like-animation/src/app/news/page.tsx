...
// 編集用テンプレート: 新しいお知らせを追加する場合は、以下の形式で NEWS_DATA 配列に追加してください
// const NEWS_DATA = [
//     {
//         date: "2026.01.15",
//         category: "サービス",
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    {NEWS_DATA.length === 0 && (
                        <div className="text-center py-20">
                            <p className="text-4xl md:text-6xl font-bold text-white/20 mb-4">Coming Soon</p>
